class PeopleController < ApplicationController
  ...
  def show_association
    ...
    case association
    when 'starships'
      @people_with_association = @person.starships.flat_map(&:people).uniq
    when 'films'
      @people_with_association = @person.films.flat_map(&:people).uniq
    when 'vehicles'
      @people_with_association = @person.vehicles.flat_map(&:people).uniq
    else
