...
class SpeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create species" do
    assert_difference("Species.count") do
      post species_index_url, params: { species: { average_lifespan: @species.average_lifespan, language: @species.language, name: @species.name, planet_id: @species.planet_id } }
    end
  ...
  test "should update species" do
    patch species_url(@species), params: { species: { average_lifespan: @species.average_lifespan, language: @species.language, name: @species.name, planet_id: @species.planet_id } }
