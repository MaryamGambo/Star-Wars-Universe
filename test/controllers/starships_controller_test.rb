...
class StarshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create starship" do
    assert_difference("Starship.count") do
      post starships_url, params: { starship: { manufacturer: @starship.manufacturer, model: @starship.model, name: @starship.name } }
    end
  ...
  test "should update starship" do
    patch starship_url(@starship), params: { starship: { manufacturer: @starship.manufacturer, model: @starship.model, name: @starship.name } }
