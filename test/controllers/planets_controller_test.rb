...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference("Planet.count") do
      post planets_url, params: { planet: { diameter: @planet.diameter, name: @planet.name, population: @planet.population } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { diameter: @planet.diameter, name: @planet.name, population: @planet.population } }
